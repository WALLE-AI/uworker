...
use agentrs::confirm::ToolConfirmer;
use agentrs::protocol::events::ToolCategory;
use agentrs::config::{Config, ProviderType, ToolsConfig, SessionConfig};
use agentrs::hooks::HooksConfig;
use agentrs::mcp::config::McpConfig;
use agentrs::provider::{LlmProvider, ProviderError};
use agentrs::tools::Tool;
use agentrs::types::llm::{LlmEvent, LlmRequest};
use agentrs::types::message::{StopReason, TokenUsage};
use agentrs::types::tool::ToolResult;
...
pub fn test_config() -> Config {
    Config {
        ...
        compat: agentrs::provider::compat::ProviderCompat::anthropic_defaults(),
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: agentrs::config::SkillsPermissionConfig::default(),
        },
        session: SessionConfig {
            enabled: false,
            directory: "/tmp/agentrs-test-sessions".to_string(),
            max_sessions: 5,
        },
        compact: agentrs::config::CompactConfig::default(),
        plan: agentrs::config::PlanConfig::default(),
