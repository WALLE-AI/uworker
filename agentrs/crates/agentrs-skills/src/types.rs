...
// Re-export EffortLevel from agentrs-types (single source of truth)
pub use agentrs_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/agentrs/skills/`
    User,
    /// .agentrs/skills/ (project-level)
    Project,
    /// .agentrs/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .agentrs/commands/ (legacy compatibility)
    Legacy,
}
