...
mod tests {
    ...
    use agentrs_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use agentrs_skills::permissions::SkillPermissionChecker;
    use agentrs_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    ...
    async fn tc_13_8_full_variable_substitution_integration() {
        let mut skill = make_skill("my-skill", "Run ${AGENTRS_SKILL_DIR}/tool.sh $ARGUMENTS[0]");
