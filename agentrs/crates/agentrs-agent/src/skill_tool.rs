...
use agentrs_skills::context_modifier::ContextModifier;
use agentrs_skills::executor::{execute_fork, prepare_inline_content};
use agentrs_skills::hooks::{parse_skill_hooks, to_hook_defs};
use agentrs_skills::permissions::{SkillPermission, SkillPermissionChecker};
use agentrs_skills::types::{ExecutionContext, SkillMetadata};
...
pub struct SkillTool {
    ...
    /// Session ID passed to prepare_inline_content for ${AGENTRS_SESSION_ID} substitution.
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        agentrs_skills::context_modifier::from_skill(skill)
    }
