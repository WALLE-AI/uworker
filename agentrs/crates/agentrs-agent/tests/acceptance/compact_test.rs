...
use agentrs_agent::compact::auto::{BOUNDARY_PREFIX, autocompact, should_autocompact};
use agentrs_agent::compact::emergency::is_at_emergency_limit;
use agentrs_agent::compact::micro::{CLEARED_TOOL_RESULT, microcompact};
use agentrs_agent::compact::state::CompactState;
