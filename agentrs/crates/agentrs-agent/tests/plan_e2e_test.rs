...
use agentrs_agent::plan::prompt::plan_mode_instructions;
use agentrs_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use agentrs_protocol::events::ToolCategory;
use agentrs_tools::Tool;
use agentrs_tools::registry::ToolRegistry;
use agentrs_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use agentrs_agent::compact::micro::microcompact;
    use agentrs_agent::plan::state::PlanState;
