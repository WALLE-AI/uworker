...
use agentrs_agent::compact::auto::{
    CompactError, autocompact, extract_compact_metadata, is_compact_boundary, should_autocompact,
};
use agentrs_agent::compact::prompt::{build_compact_prompt, build_summary_content, format_compact_summary};
...
use agentrs_types::compact::CompactTrigger;
