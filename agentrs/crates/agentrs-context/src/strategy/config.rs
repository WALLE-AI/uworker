// Ported from aionrs (Apache-2.0), crates/aion-config.
//   Source: crates/aion-config/src/compact.rs @ f711174
//   Copied: 2026-09-01   Modified: yes
//   Changes: 落到 agentrs-context 而不是新开 config crate——本仓库配置一律注入，不设配置 crate
...
pub struct CompactConfig {
    ...
    #[serde(default)]
    pub compaction: crate::compact::CompactLevel,
...
impl Default for CompactConfig {
    fn default() -> Self {
        Self {
            ...
            compaction: crate::compact::CompactLevel::default(),
            toon: false,
        }
    }
}
